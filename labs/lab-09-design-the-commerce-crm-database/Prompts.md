# Lab 09 Prompts: Design the Commerce CRM Database
...
**Acceptance check:** Initialisation is idempotent and SQLite enforces unique SKU/email, valid money/stock, order status and foreign keys.
