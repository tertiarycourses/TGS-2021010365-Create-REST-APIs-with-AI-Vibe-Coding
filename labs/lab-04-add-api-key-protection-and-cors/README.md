...
**Tools:** FastAPI Depends, Header, CORSMiddleware, OpenAI Python SDK
...
1. Perform the action exactly as stated: **Copy environment.template to .env and set a local demo key; never commit .env.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Implement require_api_key() using the X-API-Key header.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Attach the dependency to POST, PATCH and DELETE routes.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Configure CORSMiddleware for the exact frontend development origin.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Test missing, invalid and valid keys with curl or Swagger UI.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Inspect the browser preflight request and response headers.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
- Evidence names the lab number and the mapped codes: A7, A8.
