...
**Tools:** HTML, CSS, JavaScript fetch, browser devtools, imagegen UI concept, OpenAI Python SDK
...
1. Perform the action exactly as stated: **Run the completed API and open the root demo page.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Inspect loadProducts() and trace GET /api/v1/products in the Network panel.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Wire product and customer forms to POST JSON and render the returned records.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Place an order and confirm the dashboard updates order count, revenue and stock.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Display structured API errors in the accessible status region.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Test desktop and narrow-screen layouts plus empty, loading, validation and server-error states.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
- Evidence names the lab number and the mapped codes: A3, A4, A6.
