...
**Tools:** HTTPException, logging, middleware, OpenAI Python SDK
...
1. Perform the action exactly as stated: **Add request-ID middleware that accepts or creates X-Request-ID.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Log method, path, status and elapsed time without logging secrets.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Raise 404 for missing products and 409 for duplicate titles.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Add an exception handler for the public error envelope.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Trigger each error and match the response request_id to the log.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
1. Perform the action exactly as stated: **Confirm stack traces are absent from public JSON.**
2. Observe the resulting file, HTTP response, log or browser state.
3. If the expected state is absent, compare the request contract, status code and latest log entry.
4. Save one evidence item before continuing.
...
- Evidence names the lab number and the mapped codes: A5, A7.
