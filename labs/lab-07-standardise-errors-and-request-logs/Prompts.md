# Lab 07 Prompts: Standardise Errors and Request Logs
...
**Acceptance check:** 404 and 409 use the same envelope; each response request ID locates one log trace; secrets are absent.
