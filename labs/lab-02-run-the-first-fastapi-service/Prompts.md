# Lab 02 Prompts: Run the First FastAPI Service
...
**Acceptance check:** GET /health/live returns 200; /docs lists the product route; invalid path input returns structured 422 JSON.
