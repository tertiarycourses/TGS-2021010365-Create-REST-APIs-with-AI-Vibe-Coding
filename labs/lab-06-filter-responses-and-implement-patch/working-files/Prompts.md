# Lab 06 Prompts: Filter Responses and Implement PATCH
...
**Acceptance check:** PATCH changes only supplied fields and no internal database field appears in the JSON response.
